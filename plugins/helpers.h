...
#define PSTREAM_STOP_SENDING_REQUESTED(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_STOP_SENDING_REQUESTED))
#define PSTREAM_STOP_SENDING_SENT(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_STOP_SENDING_SENT))
#define PSTREAM_STOP_SENDING_RECEIVED(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_STOP_SENDING_RECEIVED))
#define PSTREAM_SEND_STOP_SENDING(stream) (PSTREAM_STOP_SENDING_REQUESTED(stream) && !PSTREAM_STOP_SENDING_SENT(stream))
#define PSTREAM_FIN_NOTIFIED(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_FIN_SIGNALLED))
#define PSTREAM_FIN_SENT(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_FIN_SENT))
#define PSTREAM_FIN_RCVD(stream) (get_stream_head(stream, AK_STREAMHEAD_FLAGS_FIN_RECEIVED))
#define PSTREAM_SEND_FIN(stream) (PSTREAM_FIN_NOTIFIED(stream) && !PSTREAM_FIN_SENT(stream))
#define PSTREAM_CLOSED(stream) ((PSTREAM_FIN_SENT(stream) || (get_stream_head(stream, AK_STREAMHEAD_FLAGS_RESET_RECEIVED))) && (PSTREAM_RESET_SENT(stream)) || (get_stream_head(stream, AK_STREAMHEAD_FLAGS_FIN_RECEIVED)))
...
#define my_calloc(cnx,nmemb,size) my_calloc_dbg(cnx,nmemb,size,__FILE__,__LINE__)
...
#define my_calloc(cnx,nmemb,size) my_calloc(cnx,nmemb,size)
