...
protoop_id_t PROTOOP_NOPARAM_DECODE_STREAM_FRAME = { .id = PROTOOPID_NOPARAM_DECODE_STREAM_FRAME };
...
protoop_id_t PROTOOP_NOPARAM_IS_MAX_STREAM_DATA_FRAME_REQUIRED = { .id = PROTOOPID_NOPARAM_IS_MAX_STREAM_DATA_FRAME_REQUIRED };
...
protoop_id_t PROTOOP_NOPARAM_BEFORE_SENDING_SEGMENT = { .id = PROTOOPID_NOPARAM_BEFORE_SENDING_SEGMENT };
protoop_id_t PROTOOP_NOPARAM_AFTER_DECODING_FRAMES = { .id = PROTOOPID_NOPARAM_AFTER_DECODING_FRAMES };
