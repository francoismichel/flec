 ...
 * @param cnx The connection pointer
 * @param pkt The packet pointer
 * @param idxs The array containing the indexes of the plugin-specific metadata to get
 * @param n_idx The number of indexes stored in idxs
 *
 */
...
/** Flags */
#define AK_STREAMHEAD_FLAGS_FIN_REQUESTED 0x09
#define AK_STREAMHEAD_FLAGS_FIN_SENT 0x0a
#define AK_STREAMHEAD_FLAGS_FIN_RECEIVED 0x0b
#define AK_STREAMHEAD_FLAGS_FIN_SIGNALLED 0x0c
#define AK_STREAMHEAD_FLAGS_RESET_REQUESTED 0x0d
#define AK_STREAMHEAD_FLAGS_RESET_SENT 0x0e
#define AK_STREAMHEAD_FLAGS_RESET_RECEIVED 0x0f
#define AK_STREAMHEAD_FLAGS_RESET_SIGNALLED 0x10
#define AK_STREAMHEAD_FLAGS_STOP_SENDING_REQUESTED 0x11
#define AK_STREAMHEAD_FLAGS_STOP_SENDING_SENT 0x12
#define AK_STREAMHEAD_FLAGS_STOP_SENDING_RECEIVED 0x13
#define AK_STREAMHEAD_FLAGS_STOP_SENDING_SIGNALLED 0x14
#define AK_STREAMHEAD_FLAGS_MAX_STREAM_UPDATED 0x15
